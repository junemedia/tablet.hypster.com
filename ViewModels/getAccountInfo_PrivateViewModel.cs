...
{
    public class getAccountInfo_PrivateViewModel
    {
        //INFO
        ...
        public List<hypster_tv_DAL.Player> userPlayers_list = new List<hypster_tv_DAL.Player>();
        ...
        public getAccountInfo_PrivateViewModel()
        {
        }
