...
var hypPrevButtonColor = "#353535";
var hypPlayPauseButtonColor = "#353535";
var hypNextButtonColor = "#353535";
var hypShuffleButtonColor = "#353535";
var hypHypsterButtonColor = "#353535";
...
function GeneratePlayerControls() {
    ...
    hypPrevButtonColor = $("#HypPlayerScript").attr("hypPrevButtonColor");
    hypPlayPauseButtonColor = $("#HypPlayerScript").attr("hypPlayPauseButtonColor");
    hypNextButtonColor = $("#HypPlayerScript").attr("hypNextButtonColor");
    hypShuffleButtonColor = $("#HypPlayerScript").attr("hypShuffleButtonColor");
    hypHypsterButtonColor = $("#HypPlayerScript").attr("hypHypsterButtonColor");
    ...
    $("#hypPlayerCont").append("<div id='hypPlayer' style='float:left; width:256px; height:200px; margin:2px 0 0 2px;' />");
    //-------------------------------------------------------------------------------
...
function GenerateControlsBar() {
    ...
    $("#hypPlayerCont").append("<div id='hypPlayerMenu' style='float:left; width:260px; height:27px;' />");


    var btn_style = "float:left; width:52px; height:50px; line-height:50px; margin:0 0 0 0; text-align:center; font-size:16px; color:#FFFFFF; cursor:pointer; font-weight:bold;";
    var btn_style_last = "float:left; width:52px; height:50px; line-height:50px; margin:0 0 0 0; text-align:center; font-size:16px; color:#FFFFFF; cursor:pointer; font-weight:bold;";


    $("#hypPlayerMenu").append("<div class=\"hypPlayer_PlPs_btn\" onclick=\"PlayPauseVideo();\" style=\" " + btn_style + " background:" + hypPlayPauseButtonColor + " url('http://" + hypHostName + "/a/" + imgs_f + "/play_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_Prev_btn\" onclick=\"PlayPrevVideo();\" style=\" " + btn_style + " background:" + hypPrevButtonColor + " url('http://" + hypHostName + "/a/" + imgs_f + "/prev_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_Next_btn\" onclick=\"PlayNextVideo();\" style=\" " + btn_style + " background:" + hypNextButtonColor + " url('http://" + hypHostName + "/a/" + imgs_f + "/next_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_Shuffle_btn\" onclick=\"ShuffleSongs();\" style=\" " + btn_style + " background:" + hypShuffleButtonColor + " url('http://" + hypHostName + "/a/" + imgs_f + "/shuffle_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_Hypster_btn\" href=\"http://hypster.com\" target=\"_blank\" style=\" display:block; " + btn_style_last + " background:" + hypHypsterButtonColor + " url('http://" + hypHostName + "/a/" + imgs_f + "/hypster_icn.png') no-repeat center;\" ></a>");
