...
function GeneratePlayerControls() {
    ...
    hypBorderBack = $("#HypPlayerScript").attr("hypBorderBack");
    ...
    $(tag_player_cont).css("width", "204px");
    $(tag_player_cont).css("height", player_height + "px");
    $(tag_player_cont).css("background-color", hypBorderBack); //SET COLOR HERE
    $(tag_player_cont).css("border-radius", "3px"); //SET COLOR HERE
    ...
    $("#hypPlayerCont").append("<div id='hypPlayer' style='float:left; width:200px; height:200px; margin:2px 0 0 2px; background-color:" + hypMainBackColor + ";' />");
    //-------------------------------------------------------------------------------
...
function GenerateControlsBar() {
    ...
    $("#hypPlayerCont").append("<div id='hypPlayerMenu' style='float:left; width:200px; height:21px; margin:0 0 0 2px; background:" + hypMainBackColor + " url(/a/" + imgs_f + "/player_back.png) repeat-x;' />");



    var btn_style = "float:left; width:24px; height:19px; line-height:19px; margin:1px 0 0 2px; border-radius:3px; text-align:center; font-size:16px; color:#FFFFFF; cursor:pointer; font-weight:bold;";
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_Prev_btn\" onclick=\"PlayPrevVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/prev_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_PlPs_btn\" onclick=\"PlayPauseVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/play_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<div class=\"hypPlayer_Next_btn\" onclick=\"PlayNextVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/next_icn.png') no-repeat center;\" />");
    $("#hypPlayerMenu").append("<a class=\"hypPlayer_Hypster_btn\" href=\"http://hypster.com\" target=\"_blank\" style=\" display:block; " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/hypster_icn.png') no-repeat center;\" ></a>");
...
function GenerateControlsBar_Additional() {
    ...
    $(".hypPlayerAddCons").css("width", "112px");
    $(".hypPlayerAddCons").css("height", "25px");
    $(".hypPlayerAddCons").css("visibility", "visible");
    $(".hypPlayerAddCons").css("background-color", hypBorderBack); //SET COLOR HERE
    $(".hypPlayerAddCons").css("border-radius", "2px");



    var playback_control_bar = "<div style='float:left; width:108px; height:21px; margin:2px 0 0 2px; background:" + hypMainBackColor + " url(/a/" + imgs_f + "/player_back.png) repeat-x; border-radius:2px;'>";

    var btn_style = "float:left; width:24px; height:19px; line-height:19px; margin:1px 0 0 2px; border-radius:3px; text-align:center; font-size:16px; color:#FFFFFF; cursor:pointer; font-weight:bold;";
    playback_control_bar += "<div class=\"hypPlayer_Prev_btn\" onclick=\"PlayPrevVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/prev_icn.png') no-repeat center;\" />";
    playback_control_bar += "<div class=\"hypPlayer_PlPs_btn\" onclick=\"PlayPauseVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/play_icn.png') no-repeat center;\" />";
    playback_control_bar += "<div class=\"hypPlayer_Next_btn\" onclick=\"PlayNextVideo();\" style=\" " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/next_icn.png') no-repeat center;\" />";
    playback_control_bar += "<a class=\"hypPlayer_Hypster_btn\" href=\"http://hypster.com\" target=\"_blank\" style=\" display:block; " + btn_style + " background: url('http://" + hypHostName + "/a/" + imgs_f + "/hypster_icn.png') no-repeat center;\" ></a>";

    playback_control_bar += "</div>";


    $(".hypPlayerAddCons").append(playback_control_bar);
}
//**************************************************************************************************************************
